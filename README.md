...
- `POST /api/v1/dashboard/projects/start` now trims custom titles and, when the title is blank or whitespace-only, derives the project title from the first 80 characters of the trimmed description.
