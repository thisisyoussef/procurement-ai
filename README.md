...
- `POST /api/v1/projects/{id}/outreach/recompare` now preserves user-facing `400` validation details and returns a safe `500` detail (`"Failed to refresh comparison. Please try again."`) for unexpected failures.
