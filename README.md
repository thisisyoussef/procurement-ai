...
- `GET /api/v1/dashboard/contacts?q=...` requires at least 2 non-space characters after trimming; shorter queries return `422` to prevent low-signal broad matches.
