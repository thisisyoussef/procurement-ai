...
- `GET /api/v1/dashboard/contacts?q=...` requires at least 2 non-whitespace characters when `q` is provided; empty/whitespace-only queries still return unfiltered contacts.
