...
- `GET /api/v1/dashboard/contacts` accepts optional `status` filters (repeated or comma-separated, including `active` and `closed`) to return contacts tied only to projects in matching statuses.
