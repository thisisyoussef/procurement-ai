...
- `GET /api/v1/dashboard/contacts?q=...` also matches digit-only phone queries against formatted contact phone numbers (for example `3125550142` matches `+1 (312) 555-0142`).
