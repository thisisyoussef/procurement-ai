...
## Search Behavior
- `GET /api/v1/projects?q=...` and `GET /api/v1/dashboard/summary?q=...` split search text into space-delimited keywords and require every keyword to match somewhere across project title or product description (case-insensitive, order-independent).
