...
- Dashboard summary attention cards now normalize legacy status formatting (including blank-status fallback to `current_stage`) so clarifying-required prompts remain visible.
