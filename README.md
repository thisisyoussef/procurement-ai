...
## Search Behavior
- `GET /api/v1/projects?q=...` and `GET /api/v1/dashboard/summary?q=...` match keywords case-insensitively across project titles, product descriptions, parsed product types, and discovered supplier fields (name, email, website, city, country).
