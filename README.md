...
- `GET /api/v1/dashboard/contacts` orders suppliers by most recent interaction first, then by higher interaction count, so follow-up-ready contacts stay at the top.
