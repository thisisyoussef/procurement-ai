...
- Requirements parsing now validates that model `product_type` is grounded in the user request text; when mismatched categories leak in, product type and supplier search queries are rebuilt from raw user intent before discovery.
