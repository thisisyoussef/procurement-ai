...
- `GET /api/v1/projects?q=...` supports multi-term queries (for example `stainless bottle`) and requires all terms to match across title and/or product description text.
