...
## Search Behavior
- `GET /api/v1/projects?q=...` matches keywords against project titles and product descriptions, and `GET /api/v1/dashboard/summary?q=...` matches keywords against project IDs, titles, and product descriptions (case-insensitive).
