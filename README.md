...
- `POST /api/v1/projects/{id}/retrospective` now returns a safe `500` detail (`"Failed to record retrospective. Please try again."`) for unexpected failures, without exposing internal exception strings.
