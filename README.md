...
- `POST /api/v1/projects/{id}/outreach/follow-up`, `POST /api/v1/projects/{id}/outreach/recompare`, `POST /api/v1/projects/{id}/outreach/auto-send`, and `POST /api/v1/projects/{id}/outreach/check-inbox` now return safe `500` details for unexpected failures, while preserving actionable `400` validation responses.
