...
- `POST /api/v1/dashboard/projects/start` trims quick-start `description` and rejects whitespace-only or post-trim descriptions under 10 characters with `422` validation errors.
