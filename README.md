...
- `POST /api/v1/projects/{id}/outreach/follow-up`, `POST /api/v1/projects/{id}/outreach/recompare`, `POST /api/v1/projects/{id}/outreach/auto-start`, and `POST /api/v1/projects/{id}/outreach/check-inbox` now return safe fixed `500` details for unexpected failures, without exposing internal exception strings.
