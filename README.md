...
## Search Behavior
- `GET /api/v1/projects?q=...` and `GET /api/v1/dashboard/summary?q=...` split queries into terms and require all terms to match across combined project title + product description text (case-insensitive, order-agnostic).
