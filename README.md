...
## Search Behavior
- `GET /api/v1/projects?q=...` and `GET /api/v1/dashboard/summary?q=...` use tokenized case-insensitive matching across both project titles and product descriptions; all query tokens must match, with punctuation and extra spaces ignored.
