...
- `POST /api/v1/projects/{id}/outreach/follow-up` now returns a safe `500` detail (`"Failed to generate follow-up emails. Please try again."`) for unexpected failures, while preserving explicit `HTTPException` responses.
