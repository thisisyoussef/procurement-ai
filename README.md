...
- `GET /api/v1/dashboard/contacts?q=...` ignores whitespace-only query text and rejects effective one-character queries with `422`, requiring at least 2 meaningful characters when a filter is provided.
