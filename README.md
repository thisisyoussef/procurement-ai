...
## Search Behavior
- `GET /api/v1/projects?q=...` and `GET /api/v1/dashboard/summary?q=...` split query text into keyword terms and require all terms to match (case-insensitive) across project id, title, or product description.
