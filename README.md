...
- `POST /api/v1/projects/{id}/retrospective` treats legacy blank `status` projects as complete when `current_stage` is complete, preserving retrospective submission for migrated records.
