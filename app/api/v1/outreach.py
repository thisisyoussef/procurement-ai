...
OUTREACH_RECOMPARE_FAILURE_DETAIL = "Failed to refresh comparison with real quotes. Please try again."
OUTREACH_AUTO_SEND_FAILURE_DETAIL = "Failed to auto-send outreach emails. Please try again."
