...
- `GET /api/v1/dashboard/contacts` orders suppliers by most recent interaction first, then
  by higher interaction count (with supplier name as final tiebreaker).
