...
- `GET /api/v1/dashboard/contacts` orders merged supplier contacts by `interaction_count`,
  then `project_count`, then recency (`last_interaction_at`), and finally supplier name.
