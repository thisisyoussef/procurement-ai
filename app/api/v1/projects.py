...
PROJECT_RETROSPECTIVE_FAILURE_DETAIL = "Failed to record retrospective. Please try again."
...
async def submit_retro(
    ...
    try:
        ...
        logger.error("Retrospective submission failed: %s", traceback.format_exc())
        raise HTTPException(status_code=500, detail=PROJECT_RETROSPECTIVE_FAILURE_DETAIL) from exc
