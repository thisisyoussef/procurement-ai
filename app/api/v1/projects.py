...
async def submit_retro(
    ...
    try:
        ...
        logger.exception("Failed to submit retrospective for project %s", project_id)
        raise HTTPException(status_code=500, detail=PROJECT_RETROSPECTIVE_FAILURE_DETAIL) from e
