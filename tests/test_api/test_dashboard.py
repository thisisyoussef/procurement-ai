...
def test_dashboard_contacts_service_keeps_supplier_with_any_allowed_project_association():
    db_rows = [
        {
            "supplier_id": "11111111-1111-1111-1111-111111111111",
    ...
    with patch("app.services.dashboard_service._ensure_dashboard_schema", new=AsyncMock()), patch(
        ...
        "app.services.dashboard_service.dashboard_repo.list_supplier_ids_for_projects",
    ...
    assert response.count == 1
    assert [supplier.name for supplier in response.suppliers] == ["Shared Supplier"]
